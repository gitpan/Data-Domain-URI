...
=head1 SYNOPSIS
    ...
    Data::Domain::URI::http->new;

=head1 DESCRIPTION

This value class uses the L<Data::Domain> mechanism and is an adapter for
L<Data::Semantic::URI::http> - see there for more information.

Data::Domain::URI::http inherits from L<Data::Domain::SemanticAdapter>.
...
This document describes version 0.01 of L<Data::Domain::URI::http>.
