...
Data::Domain::URI::file inherits from L<Data::Domain::SemanticAdapter>.

The superclass L<Data::Domain::SemanticAdapter> defines these methods and
functions:

    new(), OPTIONS(), _inspect(), adaptee(), adaptee_clear(), carp(),
    clear_adaptee(), confess(), croak(), install_shortcuts(),
    semantic_args(), semantic_class_name()
...
This document describes version 0.02 of L<Data::Domain::URI::file>.
